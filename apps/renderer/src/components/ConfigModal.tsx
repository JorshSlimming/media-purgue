...
export default function ConfigModal({ visible, counts, defaultConfig, onCancel, onConfirm, onSelectFolder, t }: Props) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-800">{t('advancedSettingsTitle')}</h2>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-700 mb-2">{t('batchSizeTitle')}</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t('imagesLabel')}</label>
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t('videosLabel')}</label>
          ...
          <div>
            <h3 className="font-semibold text-gray-700 mb-2">{t('orderingCriterion')}</h3>
            <div className="grid grid-cols-2 gap-4 items-start">
              <div className="flex justify-between items-center w-full">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm whitespace-nowrap">{t('creationDate')}</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm whitespace-nowrap">{t('sizeLabel')}</span>
                </label>
              </div>
          ...
          <div>
            <h3 className="font-semibold text-gray-700 mb-2">{t('finalFolderName')}</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-700 mb-2">{t('timePerFileTitle')}</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t('imagesSeconds')}</label>
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-1">{t('videosSeconds')}</label>
            ...
            <p className="text-xs text-gray-500 mt-1">{t('timeNote')}</p>
          </div>

          {/* Modo simple moved to start area; removed from advanced modal */}

          <div>
            <h3 className="font-semibold text-gray-700 mb-2">{t('finalFolderLocation')}</h3>
            <div className="flex gap-2">
              ...
              <button onClick={handlePickFolder} className="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded font-medium transition-colors">{t('browse')}</button>
            </div>
            <p className="text-xs text-gray-500 mt-1">{t('defaultLocationNote')}</p>
          </div>
        </div>

        <div className="mt-8 flex justify-end gap-3 border-t pt-4">
          <button onClick={onCancel} className="px-5 py-2 border rounded text-gray-600 hover:bg-gray-50 font-medium">{t('cancel')}</button>
          <button onClick={handleSave} className="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded font-medium shadow-sm transition-colors">{t('save')}</button>
        </div>
      </div>
    </div>
  )
